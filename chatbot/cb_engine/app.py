...
# 객체 초기화 및 데이터베이스 연결
p = Preprocessing(
    word2index_dic="C:/Users/HP/Documents/GitHub/bag/bagcation/chatbot/cb_engine/train_tools/dict/chatbot_dict.bin",
    userdic="C:/Users/HP/Documents/GitHub/bag/bagcation/chatbot/cb_engine/utils/user_dic.tsv",
)
db = Database(
...
# IntentModel 초기화
intent = IntentModel(
    model_name="C:/Users/HP/Documents/GitHub/bag/bagcation/chatbot/cb_engine/models/intent/intent_model.h5",
    preprocess=p,
)

# NerModel 초기화
ner = NerModel(
    model_name="C:/Users/HP/Documents/GitHub/bag/bagcation/chatbot/cb_engine/models/ner/ner_model.h5",
    preprocess=p,
)
